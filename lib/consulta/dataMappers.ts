...
export const mapLoanTrackingResponse = (
  ...
  return {
    ...
    baseInterestRate: typeof (apiData as any).baseInterestRate === 'string' ? parseFloat((apiData as any).baseInterestRate) : ((apiData as any).baseInterestRate || 0),
    penaltyInterestRate: typeof (apiData as any).penaltyInterestRate === 'string' ? parseFloat((apiData as any).penaltyInterestRate) : ((apiData as any).penaltyInterestRate || 0),
